<?php
namespace Staff\inventories;

use Staff\libs\muqsit\invmenu\inventories\DoubleChestInventory;
...
class InvSeePlayerInventory extends DoubleChestInventory implements InvSeeInventory {
	...
	public function getSpyerContents(): array {
		...
		$contents[46] = Item::get(Item::STAINED_GLASS_PANE, 15)->setCustomName(TextFormat::RESET . TextFormat::AQUA . "Casco ->");
		$contents[49] = Item::get(Item::STAINED_GLASS_PANE, 15)->setCustomName(TextFormat::RESET . TextFormat::AQUA . "<- Pechera | Pantalones ->");
		$contents[52] = Item::get(Item::STAINED_GLASS_PANE, 15)->setCustomName(TextFormat::RESET . TextFormat::AQUA . "<- Botas");
